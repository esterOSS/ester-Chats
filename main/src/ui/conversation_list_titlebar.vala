...
[GtkTemplate (ui = "/im/echats/Dino/conversation_list_titlebar.ui")]
...
public static Adw.HeaderBar get_conversation_list_titlebar_csd() {
    Builder builder = new Builder.from_resource("/im/echats/Dino/conversation_list_titlebar_csd.ui");
...
private static void create_add_menu(MenuButton add_button, MenuButton menu_button) {
    ...
    Builder add_builder = new Builder.from_resource("/im/echats/Dino/menu_add.ui");
    MenuModel add_menu_model = add_builder.get_object("menu_add") as MenuModel;
    add_button.set_menu_model(add_menu_model);

    Builder menu_builder = new Builder.from_resource("/im/echats/Dino/menu_app.ui");
